...
public class ExceptionController {
    ...
    @ExceptionHandler({ InvalidTransactionError.class })
    @ResponseStatus(BAD_REQUEST)
    @ResponseBody
    public ApiErrorMessage handleAlreadyExistingError(InvalidTransactionError alreadyExistingError)
    {
    ...
    private String getErrorFrom(InvalidTransactionError alreadyExistingException)
    {
